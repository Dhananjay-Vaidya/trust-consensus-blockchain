...
Usage:
    python experiments/run_significance_tests.py --results-dir experiments/results/ --output-dir experiments/tables/
"""
...
def generate_results_table(
    results_dir: str,
    output_path: str = "experiments/tables/statistical_table.csv",
    nodes: int = 16,
    episodes: int = 50,
) -> pd.DataFrame:
