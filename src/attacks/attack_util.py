...
from src.attacks.nma_attack import simulate_nma_attack
from src.attacks.cra_attack import simulate_cra_attack
from src.attacks.aaa_attack import simulate_aaa_attack
from src.attacks.bfi_attack import ByzantineFaultInjection
from src.attacks.tdp_attack import TimeDelayedPoisoning
    ...
    **kwargs: Any,
    ...
    if attack_type == "none":
        ...
        if "nma" not in _attack_instances:
            from src.attacks.nma_attack import NoiseManipulationAttack
        ...
        if "cra" not in _attack_instances:
            from src.attacks.cra_attack import CollusiveRumorAttack
...
def reset_attack_instances() -> None:
    ...
    try:
        from src.attacks.aaa_attack import reset_aaa_instance
        reset_aaa_instance()
    except Exception:
        pass

    try:
        from src.attacks.tdp_attack import reset_tdp_instance
        reset_tdp_instance()
    except Exception:
        pass

    try:
        from src.attacks.bfi_attack import reset_bfi_instance
        reset_bfi_instance()
    except Exception:
        pass
